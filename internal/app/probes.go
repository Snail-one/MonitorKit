...
func (a *App) showAlloyAccessCard(ctx context.Context) {
	...
	a.ui.Card(ui.Neutral, "Grafana Alloy 统一探针安装命令",
		ui.Field{Value: "curl -fsSL https://raw.githubusercontent.com/Snail-one/MonitorKit/main/scripts/probes/alloy/install.sh | sudo bash", Detail: "安装菜单默认使用官方 Release 二进制，也可选择 Grafana 软件包"},
